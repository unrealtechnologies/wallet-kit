...
#ifndef WALLET_KIT_LIB_ENGLISH_WORDLIST_H
#define WALLET_KIT_LIB_ENGLISH_WORDLIST_H

#include <iostream>

const std::string EnglishWordList[2048] = {
        "abandon",
        "ability",
        "able",
        "about",
...
#endif //WALLET_KIT_LIB_ENGLISH_WORDLIST_H
