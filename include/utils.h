...
#ifndef WALLET_KIT_LIB_UTILS_H
#define WALLET_KIT_LIB_UTILS_H
...
namespace walletKitUtils {
    ...
    inline std::string to_hex(std::vector<uint8_t> &vec, const size_t len) {
        std::stringstream ss;
        for(int i = 0; i < len; ++i) {
